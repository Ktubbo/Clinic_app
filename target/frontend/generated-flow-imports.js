...
import $css_0 from 'Frontend/views/customers/customers-view.css';
addCssBlock(`<custom-style><style>${$css_0}</style></custom-style>`);
import $css_1 from 'Frontend/views/appointments/appointments-view.css';
addCssBlock(`<custom-style><style>${$css_1}</style></custom-style>`);
import $css_2 from 'Frontend/views/treatments/treatments-view.css';
addCssBlock(`<custom-style><style>${$css_2}</style></custom-style>`);
import $css_3 from 'Frontend/views/schedules/schedules-view.css';
...
import $css_5 from 'Frontend/views/ratings/ratings-view.css';
...
import $css_7 from 'Frontend/views/timetables/time-tables-view.css';
addCssBlock(`<custom-style><style>${$css_7}</style></custom-style>`);
import $css_8 from 'Frontend/views/main/main-view.css';
