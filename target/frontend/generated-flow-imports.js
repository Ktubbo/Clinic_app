...
import $css_0 from 'Frontend/views/appointments/appointments-view.css';
...
import $css_2 from 'Frontend/views/schedules/schedules-view.css';
...
import $css_4 from 'Frontend/views/customers/customers-view.css';
addCssBlock(`<custom-style><style>${$css_4}</style></custom-style>`);
import $css_5 from 'Frontend/views/main/main-view.css';
addCssBlock(`<custom-style><style>${$css_5}</style></custom-style>`);
import $css_6 from 'Frontend/views/timetables/time-tables-view.css';
addCssBlock(`<custom-style><style>${$css_6}</style></custom-style>`);
import $css_7 from 'Frontend/views/employees/employees-view.css';
