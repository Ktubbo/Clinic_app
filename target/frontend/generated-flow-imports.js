...
import $css_1 from 'Frontend/views/timetables/time-tables-view.css';
addCssBlock(`<custom-style><style>${$css_1}</style></custom-style>`);
import $css_2 from 'Frontend/views/employees/employees-view.css';
addCssBlock(`<custom-style><style>${$css_2}</style></custom-style>`);
import $css_3 from 'Frontend/views/ratings/ratings-view.css';
addCssBlock(`<custom-style><style>${$css_3}</style></custom-style>`);
import $css_4 from 'Frontend/views/appointments/appointments-view.css';
...
import $css_8 from 'Frontend/views/customers/customers-view.css';
